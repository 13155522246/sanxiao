...
import { WebpRes } from "./manageWebp";
...
export class LoadManager {
    ...
    public hashMap: any;
    private FixedDataTablesDir = `res/data/fixed_tables`;
    public WebpRes: any;
    constructor() {
    ...
    public clearAssets(assetsList: any) {
        ...
        // managewebp
        const assetsList_bak: any = this.WebpRes.Instance().backToResList(assetsList, true);
    ...
    public clearTextureRes(assetsList: any) {
        ...
        const assetsList_bak: any = this.WebpRes.WebpRes.Instance().backToResList(assetsList, true);
